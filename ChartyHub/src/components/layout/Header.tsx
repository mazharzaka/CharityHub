...
function Header() {
  return (<>
    <div className='w-full h-16 bg-white border-b-[1px] border-[#f0f1f2]'>
    ...
    <div className='w-full h-24 bg-white shadow-xl shadow-[rgba(25,25,25,0.1)]' >
      <div className='flex items-center  h-full w-full justify-between !py-2 !px-8'>
        <Logo />
      <div className="flex">
        <Navs items={navLinks}/>
