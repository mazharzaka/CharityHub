  ...
  return (<>
    ...
    <div className="h-12 !p-1 ">
      ...
      <div className="w-full !mt-7">
        <TooltipProvider >
          <Tooltip >
            <TooltipTrigger>    <div className="!mt-5 w-[300px] flex justify-center"><Progress value={(el.goalAmount > 0 ? ((el.currentAmount || 0) / el.goalAmount) * 100 : 0)} className="w-[90%] " /></div></TooltipTrigger>
            <TooltipContent>
              {(el.goalAmount > 0 ? ((el.currentAmount || 0) / el.goalAmount) * 100 : 0)}
            </TooltipContent>
          </Tooltip>
        </TooltipProvider></div>
