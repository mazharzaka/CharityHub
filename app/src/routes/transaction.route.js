...
router.put('/:id/:campaignId/status',auth.verifyToken,role.checkRole(['admin'],true),transactionController.updateStatus);
router.delete('/:id',auth.verifyToken,role.checkRole(['admin']),transactionController.deleteTransaction);
router.put('/:id/link/:campaignId',auth.verifyToken,role.checkRole(['admin','donor'],true),transactionController.linkTransactionToCampaign);
